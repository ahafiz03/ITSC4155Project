...
class ManageEventsTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.updated_event_data = {'title': 'Updated Test Event', 'start': '2024-01-01'}
    ...
    def test_edit_event(self):
        ...
        # Edit the event
        response = self.client.put(f'/edit_event/{event_id}', data=json.dumps(self.updated_event_data), content_type='application/json')
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
        self.assertTrue(data['success'])
        ...
        with app.app_context():
            ...
            self.assertEqual(event.start, '2024-01-01')
